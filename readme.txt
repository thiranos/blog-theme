...
= 1.0.1 - Jan 15 2015 =
* Multiple fixes to improve the creation of child themes
...
* Images: images by Picjumbo (http://picjumbo.com/), licensed under [CC0](http://creativecommons.org/choose/zero/) and Unsplash (http://unsplash.com/), licensed under [CC0](http://creativecommons.org/choose/zero/)